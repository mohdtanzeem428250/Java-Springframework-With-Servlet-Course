...
//        }
        ...
        List<Student> std_list=jdbcTemplate.query(select_sql_query, new StudentRowMapper(),roll1);
        for(Student std : std_list)
        {
        	System.out.println("Roll Number : "+std.getRoll_number());
        	System.out.println("Name : "+std.getName());
        ...
        int roll=102;
        String select_sql_query1="select *from student where Roll_Number=?";
        Student std =jdbcTemplate.queryForObject(select_sql_query, new StudentRowMapper(),roll);
     	System.out.println("Roll Number : "+std.getRoll_number());
     	System.out.println("Name : "+std.getName());
     	System.out.println("Marks : "+std.getMarks());
     	System.out.println("Class : "+std.getClass());
     	System.out.println("-----------------------------------");
    }
}
